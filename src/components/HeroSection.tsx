  ...
  return <section className="relative overflow-hidden bg-[#f2f8fb]">
    ...
    <div className="container-wide relative grid min-h-[600px] items-center gap-10 py-14 lg:grid-cols-[1fr_1.06fr] lg:py-20">
      <div className="relative z-10 max-w-[660px] animate-slide-up">
        ...
        <div className="mt-12 flex items-center gap-3 text-xs font-semibold uppercase tracking-[.13em] text-primary/55"><span className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-accent shadow-sm animate-glow"><Sparkles size={17} /></span> Visagismo inteligente · Atendimento humano</div>
      </div>
      <div className="relative min-h-[380px] self-stretch lg:min-h-[530px]">
        ...
        <div className="absolute -bottom-5 left-3 flex items-center gap-3 rounded-2xl bg-white/95 p-4 shadow-soft backdrop-blur sm:-left-7 sm:p-5 animate-float border border-primary/5"><span className="flex h-11 w-11 items-center justify-center rounded-xl bg-accent/10 text-accent"><ScanFace size={24} /></span><span><strong className="block text-sm text-primary">Seu estilo começa aqui</strong><small className="text-xs text-ink/60">Uma nova perspectiva para seu olhar</small></span></div>
      </div>
    </div>
  </section>;
}
