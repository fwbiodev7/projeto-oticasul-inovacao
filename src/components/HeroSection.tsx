  ...
  return <section className="relative overflow-hidden bg-[#f2f8fb]">
    ...
    <div className="container-wide relative grid min-h-[600px] items-center gap-10 py-14 lg:grid-cols-[1fr_1.06fr] lg:py-20">
      <div className="relative z-10 max-w-[660px] animate-fade-in">
        <span className="eyebrow"><span className="relative flex h-2 w-2"><span className="animate-ping-slow absolute inline-flex h-full w-full rounded-full bg-accent opacity-75"></span><span className="relative inline-flex rounded-full h-2 w-2 bg-accent"></span></span> DESDE 2000, CUIDANDO DO SEU OLHAR</span>
        ...
        <p className="mt-6 max-w-lg text-base leading-8 text-ink/70 sm:text-lg">A tradição da Ótica Fábio encontra uma experiência feita para você. Descubra armações que valorizam seu rosto com a ajuda da inteligência artificial.</p>
