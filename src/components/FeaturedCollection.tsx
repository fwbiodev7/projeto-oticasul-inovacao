...
export function FeaturedCollection() {
  ...
  return <><div className="section-heading"><div><span className="eyebrow">CURADORIA COM PERSONALIDADE</span><h2 className="section-title mt-4">Seu próximo <em>favorito.</em></h2></div><Link href="/catalogo" className="text-link">Ver coleção completa <ArrowUpRight size={18} /></Link></div>
