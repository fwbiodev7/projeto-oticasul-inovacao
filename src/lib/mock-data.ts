...
export const products: Product[] = [
  ...
  { id: '17', name: 'Sunset Âmbar', brand: 'Coleção Sul', price: 419, image: '/images/frame-cat-eye.png', category: 'Sol', frameShape: 'Gatinho', tags: ['Sofisticado', 'Proteção UV400'], color: 'Âmbar Degradê' },
