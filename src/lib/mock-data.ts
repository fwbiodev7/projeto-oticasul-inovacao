...
export const whatsappUrl = (message = 'Olá! Vim pelo site da Ótica Fábio e gostaria de atendimento.') =>
...
export const products: Product[] = [
  ...
  { id: '17', name: 'Sua Cidade Sunset', brand: 'Coleção Fábio', price: 419, image: '/images/frame-cat-eye.png', category: 'Sol', frameShape: 'Gatinho', tags: ['Sofisticado', 'Proteção UV400'], color: 'Âmbar Degradê' },
