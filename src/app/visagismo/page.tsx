    ...
    <section className="relative overflow-hidden bg-primary text-white">
      ...
      <div className="container-wide relative grid gap-10 py-16 lg:grid-cols-[1.2fr_.8fr] lg:items-center lg:py-20">
        <div>
          ...
          <p className="mt-6 max-w-xl text-sm leading-8 text-white/70 sm:text-base">Uma foto, novas possibilidades. Receba sugestões de formatos que podem valorizar seus traços e descubra peças para experimentar na Ótica Fábio.</p>
